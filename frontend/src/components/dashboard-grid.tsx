...
export function Panel({ label, children, className = "" }: PanelProps) {
  return (
    <div className={`flex flex-col bg-[#0E0E11] border border-white/5 rounded-2xl shadow-[inset_0_1px_0_0_rgba(255,255,255,0.02)] overflow-hidden relative ${className}`}>
      {label && (
