...
const COPY =
  "In traditional AMMs, liquidity is static. As probability approaches certainty, information asymmetry extracts your capital. Omniverse makes liquidity a dynamic function of probability. We defend your yield.";

function tokenizeWords(raw: string) {
...
function RevealToken({ value, animIndex, totalAnimated, scroll }: { value: string, animIndex: number | null, totalAnimated: number, scroll: number }) {
...
function GhostLayer({ raw, textColor, ghostOpacity, textAlign }: any) {
    ...
    >
      ...
      <div className="sticky top-0 h-screen flex items-center justify-center px-6">
        <div className="max-w-5xl mx-auto w-full">
          ...
          <div style={{ position: "relative", width: "100%", whiteSpace: "pre-wrap", textAlign: "left", wordSpacing: "0.2em" }}>
