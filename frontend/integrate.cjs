...
${routeDefExp.replace('component: ExplorerPage,', 'component: () => (<div className="relative min-h-screen w-full overflow-x-hidden bg-[#0A0A0B]"><div className="border-b border-white/[0.05]"><NavBar hideWallet /></div><ExplorerPage /></div>),')}
`;
...
${routeDefSim.replace('component: SimulatePage,', 'component: () => (<div className="relative min-h-screen w-full overflow-x-hidden bg-[#0A0A0B]"><div className="border-b border-white/[0.05]"><NavBar hideWallet /></div><WrappedSimulatePage /></div>),')}
`;
