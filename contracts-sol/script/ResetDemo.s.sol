...
contract ResetDemo is Script {
    function run() external {
        ...
        string memory question = string(
            abi.encodePacked(
                "Will ETH reach 10k in 2026? (Demo ",
        ...
        console.log(
            "NOTE: MultiverseLending is bound to a single condition ID!"
        );
        console.log(
            "To fully reset the demo, you must deploy a NEW MultiverseLending instance with the new conditionId."
        );
